[![Run App Herman Dolezal](https://github.com/Hdolezal/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Hdolezal/GithubActions/actions/workflows/run-app.yaml)
